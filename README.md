...
*   **Кастомизация:** опции скрытия преподавателей и прошедших пар, показ завтрашнего дня.
...
### 📖 Зачётка
*   **Оценки и контрольные:** зачётка MyITMO с прогрессом по предметам.
*   **БАРС:** чип накладывает баллы и работы из БАРС на тот же список.
*   **Физкультура:** баллы «Моего спорта» прямо в карточке предмета.

### 👥 Друзья
*   **Заявки и профили:** добавляйте друзей, смотрите их расписание и спорт, если они это разрешили.
*   **Приватность:** кто видит ваше расписание и спорт, решаете вы: все, друзья или никто.
*   **Поиск людей:** по имени через MyITMO, с приглашением тех, кто ещё не в приложении.
...
Документация для разработчиков: [docs/README.md](docs/README.md).
